...
if(mysqli_num_rows($result2)>0){
   ...
   echo "<tr>" . "<td>" . $row['name'] . "</td>" . "<td> <img width=100px src=http://localhost/project2/". $row['discription'] .">" . "</td>"
    . "<td>" . $status . "</td>" .  "<td> <a href='edit.php?id=".$row['id']."' class='btn btn-outline-primary  box-shadow-3 mr-1 mb-1'><i
            class='icon-eye'></i></a>
</td>" .
"<td>
    <form action='delete.php' method='post' id='form-script' class='form-delete'>
