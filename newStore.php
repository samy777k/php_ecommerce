						...
						<form class="form" method="POST" action="" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" id="donationinput1" class="form-control square" placeholder="name" name="store-name">
									<?php
...
?>
								...
								<div class="form-group">
									...
									<input type="text" id="donationinput2" class="form-control square" placeholder="address" name="store-address">
									<?php
...
?>
								...
								<div class="form-group">
									...
									<input type="tel" id="donationinput3" class="form-control square" name="store-phone">
									<?php
